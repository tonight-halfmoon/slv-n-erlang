...
api_from_list_test_() ->
    {
      ...
      ?_assertEqual({lns,{node,v1,{node,v2,{node,v3,undefined,undefined},undefined},undefined}}, lns:from_list(['v1', 'v2', 'v3']))
    }.
...
api_to_list_test_() ->
    {
      ...
      ?_assertMatch([{v1, T1},
                      {v2, T2},
                      {v3, T3}] when T1 > 0; T2 > 0; T3 > 0, lns:to_list(setup(1,3)))
    }.
...
api_tail_test_() ->
	...
	fun(Lns) ->
		[?_assertEqual({node, v1, undefined, undefined}, lns:tail(Lns))]
	end
      }
    }.
...
api_pop_test_() ->
	...
	fun() -> setup(3) end,
	fun(Lns) ->
		[?_assertEqual({v1,{lns,{node,v2,{node,v3,undefined,undefined},undefined}}}, lns:pop(Lns))]
	end
      }
    }.
